...
def get_investment_recommendation(coin, coin_data, coin_opens, coin_highs, coin_lows,coin_closes, gpt_api, option,coin_date):
    ...
    prompt = f"{coin} Can you guess whether it will up or down after 1 hour ? just write the guess up or down {option} investment strategy. today's chart: {coin_prompt}\n\n{coin}-USD live price: {coin_price}\n\n"
    print(prompt)
    body = {
        "prompt": prompt,
        "max_tokens": 585,
