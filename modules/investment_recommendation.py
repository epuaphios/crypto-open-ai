...
def get_investment_recommendation(coin, coin_data, coin_opens, coin_highs, coin_lows,coin_closes, gpt_api, option):
    ...
    prompt = f"{coin} Can you tell me the support and resistance price of the coin based on historical data ?  {option} investment strategy. Past price information is here for 90 days : {coin_prompt}\n\n{coin}-USD live price: {coin_price}\n\n"
    print(prompt)
    body = {
        "prompt": prompt,
        "max_tokens": 585,
